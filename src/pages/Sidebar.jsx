...
import LogOutModal from "../components/LogOutModal.jsx";
  ...
  const totalProvincesCount = provinceData.length; // or Object.keys(chartData.provinces).length
      ...
      <div className="flex min-h-screen">
        <div className="w-64 flex flex-col bg-gradient-to-b from-white to-[#63a8e9]">
          ...
          <div className="flex flex-col items-center mb-4">
            ...
            <p className="text-gray-800 font-semibold">Dashboard</p>
            <p className="text-gray-600 text-xs">denzraymond@gmail.com</p>
          </div>
